...
<ul><li><a href=https://github.com/Jack-Works/ts-esm-migrate>Jack-Works/ts-esm-migrate</a><p>Migrate code to NodeNext module resolution by add .js extension</p></li><li><a href=https://github.com/teaxyz/cli>teaxyz/cli</a><p>the unified package manager (brew2)</p></li><li><a href=https://github.com/RRethy/vim-illuminate>RRethy/vim-illuminate</a><p>illuminate.vim - (Neo)Vim plugin for automatically highlighting other uses of the word under the cursor using either LSP, Tree-sitter, or regex matching.</p></li><li><a href=https://github.com/blakesanie/React-Bubble-UI>blakesanie/React-Bubble-UI</a><p>A highly configurable Bubble UI React.js component, similar to the iconic Apple Watch app layout.</p></li><li><a href=https://github.com/folke/trouble.nvim>folke/trouble.nvim</a><p>🚦 A pretty diagnostics, references, telescope results, quickfix and location list to help you solve all the trouble your code is causing.</p></li></ul>
...
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！<br>刷新于：12/3/22, 8:29 AM<br>下一次刷新：12/4/22, 8:29 AM</p>
