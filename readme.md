...
<ul><li><a href=https://github.com/drudru/ansi_up>drudru/ansi_up</a><p>A javascript library that converts text with ANSI terminal codes into colorful HTML Zero dependencies.</p></li><li><a href=https://github.com/geist-org/geist-ui>geist-org/geist-ui</a><p>A design system for building modern websites and applications.</p></li><li><a href=https://github.com/yanmao-cc/itellyou>yanmao-cc/itellyou</a><p>一个知识付费、协同编辑项目</p></li><li><a href=https://github.com/Platane/snk>Platane/snk</a><p>🟩⬜ Generates a snake game from a github user contributions graph and output a screen capture as animated svg or gif</p></li><li><a href=https://github.com/red-axe/am-editor>red-axe/am-editor</a><p>A rich text collaborative editor framework that can use React and Vue custom plug-ins. 一个富文本实时协同编辑器框架，可以使用React和Vue自定义插件。</p></li></ul>

**曾经看了...**

<ul><li><a href=https://github.com/sindresorhus/pretty-ms>sindresorhus/pretty-ms</a><p>Convert milliseconds to a human readable string: `1337000000` → `15d 11h 23m 20s`</p></li><li><a href=https://github.com/pulumi/pulumi>pulumi/pulumi</a><p>Pulumi - Universal Infrastructure as Code. Your Cloud, Your Language, Your Way 🚀</p></li><li><a href=https://github.com/MichealWayne/books>MichealWayne/books</a><p>一些前端/设计相关的书籍（电子书）</p></li><li><a href=https://github.com/BuilderIO/qwik>BuilderIO/qwik</a><p>The HTML-first framework. Initialize apps of any size with ~ 1kb JS</p></li><li><a href=https://github.com/reactify-component/react-shortcut-guide>reactify-component/react-shortcut-guide</a><p>Long-press `⌘` key or press `?` to present a shortcut guide for your Web application.</p></li></ul>
...
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！<br>刷新于：7/13/22, 8:34 AM<br>下一次刷新：7/14/22, 8:34 AM</p>
